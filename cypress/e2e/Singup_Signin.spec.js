...
describe("Sign up and Sign in forms", () => {
    ...
    it("Should see Sign up Button and navigate to Sign up form", () => {
        ...
        cy.intercept('POST', 'https://filmflicks.herokuapp.com/api/auth/sign_up')
    })
    it("Should see Sign in Button and navigate to Sign in form", () => {
